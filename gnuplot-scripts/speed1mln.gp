...
unset ttics
set title "Speedup for 1mln elements" 
...
plot [][:50] for [IDX=0:1] "data/benchmark-1000000.txt" i IDX u 1:(seq1mln/$2) title columnheader(1) w lines smooth bezier, f(x) t "ideal"
#    EOF
