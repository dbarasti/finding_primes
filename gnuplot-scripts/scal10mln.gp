...
unset ttics
set title "Scalability for 10mln elements" 
set title  font ",13" norotate
...
set xlabel "#workers" 
set xlabel  font ",13" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "scalability factor" 
...
plot for [IDX=0:1] "data/benchmark-10000000.txt" i IDX u 1:(scal10mln[IDX+1]/$2) title columnheader(1) w lines smooth bezier
#    EOF
