...
unset ttics
set title "Speedup for 10mln elements" 
...
plot [][:50] for [IDX=0:1] "data/benchmark-10000000.txt" i IDX u 1:(seq10mln/$2) title columnheader(1) w lines smooth bezier, f(x) t "ideal"
#    EOF
